...
datas = [('config', 'config'), ('README.md', '.'), ('ffmpeg.exe', '.'), ('ffprobe.exe', '.'), ('gemini_translator\\scripts\\chatgpt_workascii_bridge.cjs', 'gemini_translator\\scripts'), ('gemini_translator\\scripts\\chatgpt_profile_launcher.cjs', 'gemini_translator\\scripts'), ('qidian_rulate\\tags.txt', 'qidian_rulate'), ('.venv\\Lib\\site-packages\\playwright\\driver\\node.exe', 'playwright_runtime'), ('.venv\\Lib\\site-packages\\playwright\\driver\\package', 'playwright_runtime\\package'), ('C:\\Users\\shest\\AppData\\Local\\ms-playwright', 'playwright_runtime\\ms-playwright')]
